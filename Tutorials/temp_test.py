...
from PluginCore.Decoder.trainer.utils import boxplot_res, param3d_viz, return_df_search
...
# Define algorithm
alg = {
    1: SkorchFactory(Model=ShallowFBCSPNet,max_epochs=100),
    2: CSPFactory(Model=FBCSP),
    3: SkorchRandSearch(Model=ShallowFBCSPNet,n_iter=10,max_epochs=100),
