...
from bciplugin.Core.Decoder.module.braindecode.core.modules import Expression, Ensure4d_ext, safe_log, square, \
    Transaction_ext
...
class ExtractorMarkI(nn.Sequential):
    def __init__(self, n_chan, n_filter_time=40, kernel_size_time=25, kernel_size_pool=75, stride=15, n_filter_spat=40,
                 kernel_size_spat=5, cuda=False):
        ...
        self.add_module('conv_spat',
                        nn.Conv2d(self.n_filter_time, self.n_filter_spat, kernel_size=(kernel_size_spat, 1),
