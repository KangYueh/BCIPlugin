...
def _create_description(description):
    ...
    Args:
        description (dict or pandas.Series or None):
            Additional description about the data.
...
def fetch_data_description(data):
    ...
    Returns:
        tuple:
            Tuple containing lists of raw data and a pandas DataFrame with descriptions.
    """
