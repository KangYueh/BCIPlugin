...
def _check_windowing_arguments(
        ...
        window_size_samples, window_stride_samples):
    """
    Check validity of windowing arguments.

    Parameters:
        trial_start_offset_samples (int):
            Start offset from trial onsets, in samples.
        trial_stop_offset_samples (int | None):
            Stop offset from trial stops, in samples.
        window_size_samples (int | None):
            Window size.
        window_stride_samples (int | None):
            Stride between windows.
